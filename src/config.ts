...
export const siteConfig: SiteConfig = {
	title: "Anime英梨梨的博客",
	subtitle: "",
	siteURL: "https://solaiolyuii-ux.github.io", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-03-08", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	bangumi: {
		userId: "your-bangumi-vmid", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
		fetchOnDev: false, // 是否在开发环境下获取 Bangumi 数据（默认 false），获取前先执行 pnpm build 构建 json 文件
	},

	bilibili: {
		vmid: "355928123", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	font: {
	  ...
	  cjkFont: {
	    // 中日韩字体 - 作为回退，也使用系统默认的中文字体
	    fontFamily: "system-ui, -apple-system, 'PingFang SC', 'Microsoft YaHei', 'WenQuanYi Micro Hei', sans-serif",
	    fontWeight: "400",
	    // 不再使用本地字体文件
	    localFonts: [],
	    // 关闭字体压缩
	...
	links: [
		{
			name: "Bilibili",
			icon: "fa7-brands:bilibili",
			url: "https://space.bilibili.com/355928123",
		},

		{
			name: "GitHub",
			icon: "fa7-brands:github",
			url: "https://github.com/solaiolyuii-ux?tab=repositories",
		},
		{
			name: "Codeberg",
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://peaceful-cocada-4a0401.netlify.app/.netlify/functions/twikoo",
		lang: SITE_LANG,
	},
};
